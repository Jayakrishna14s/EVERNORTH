...
export default function LoginForm() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      console.error('Login error:', err); // Log any errors to debug
      setError('Invalid Member ID or Password'); // Display error message
    }
  };
...
const styles = {
  ...
  container: {
    ...
    borderRadius: '8px',
    maxWidth: '500px',
    width: '90%', // Sets container width for larger screens
